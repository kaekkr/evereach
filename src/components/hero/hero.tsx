        ...
        >
          ...
          <span className="inline-flex items-center align-middle ml-3 sm:ml-5 relative">
            <motion.button
              ...
              className="relative h-14 rounded-full border backdrop-blur-md cursor-pointer overflow-hidden font-mono uppercase tracking-widest text-white select-none shrink-0"
              whileTap={{ scale: 0.95 }}
            >
              {/* Arrow Icon Layer */}
              <motion.span
              ...
              <motion.span
                ...
                transition={{ duration: 0.2, ease: "easeInOut" }}
                className="absolute inset-0 flex items-center justify-center gap-2 text-xs sm:text-sm font-medium whitespace-nowrap text-purple-100 pointer-events-none w-max mx-auto pl-1"
              >
